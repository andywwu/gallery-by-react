...
var ImgFigure = React.createClass({
	...
	render: function(){
		...
		var imgFigureClassName = 'image-figure';
...
// @return {function}
 ...
 getInitialState: function () {
  ...
  componentDidMount: function(){
	var statgeDOM = React.findDOMNode(this.refs.stage),
		stageW = statgeDOM.scrollWidth,
		stageH = statgeDOM.scrollHeight,
